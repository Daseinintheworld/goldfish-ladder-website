...
import lindedin from "@/assets/icons/in Icons.png";
          ...
          <div className="flex justify-center items-center w-full">
            ...
            <div className=" flex flex-col items-center  w-full max-w-[800px]">
              ...
              <input
                ...
                />
                      <span className="ml-2  font-medium md:text-lg text-[13px]">REMEMBER ME</span>
                    </label>
                    ...
                    <label className="inline-flex items-center">
                      ...
                      <span className="ml-2 md:text-lg text-[13px] font-medium">
                        I do accept the <span className="underline">Terms and condition</span> of your site.
                      </span>
                    </label>
                  </div>
                </div>
                  ...
                  <div className="flex flex-row gap-[8%] justify-center w-full mb-5">
                    ...
                    <div>
                      <Image
                        ...
                        width={40}
                        height={40}
                        className="w-[40px] h-[40px] max-w-3xl  mx-auto mb-4 animate-slide-down"
                      />
                      <p className="text-sm  md:text-md lg:text-md  ">Instagram</p>
                    </div>
                    <div>
                      <Image
                        src={lindedin}
                        ...
                        className="w-[40px] h-[40px] max-w-3xl mx-auto mb-4 animate-slide-down"
                      />                    
                     <p className="text-sm md:text-md lg:text-md ">LinkedIn</p> 
                    </div>
                  </div>
                  <p className="text-md font-bebas md:text-lg lg:text-xl font-medium ">Already a user?</p>
                  <p className="text-md font-bebas md:text-lg lg:text-xl font-medium mb-12 text-[#854836]">login</p>
